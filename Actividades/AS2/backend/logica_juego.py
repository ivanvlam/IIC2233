...
class Juego(QObject):
    ...
    senal_emitir_grilla = pyqtSignal(dict)
    ...
    def comenzar_partida(self):
        self.enviar_bloque()
        self.timer = QTimer()
        self.timer.setInterval(self.tiempo_de_avance)
        self.timer.timeout.connect(self.avanzar_bloques)
        self.timer.start()
    ...
    def actualizar_grilla(self):
        ...
        self.senal_emitir_grilla.emit(self.diccionario_grilla)
