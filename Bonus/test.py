...
from api import descargar_documento, entregar_consulta
import json
...
if __name__ == "__main__":
    ...
    # Tests de api
    '''
    descargar_documento(73, 'test.md')
    with open('test.md') as f:
        archivo = f.read()
    
    lista = consulta_6(archivo, PATRON_6)
    
    print(entregar_consulta(6, 73, PATRON_6, lista))
    '''
